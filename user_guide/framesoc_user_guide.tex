...
\RCGrenoble 
%%
\abstract{This guide describes the Framesoc workbench. The document targets the end-users.}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=1.0\textwidth]{images/perspective_no_table.png}
  \caption{Framesoc Eclipse Workbench}
  \label{fig:all_perspective}
\end{figure}

The Framesoc workbench provides an Eclipse perspective\footnote{Within an Eclipse application, a perspective defines an initial set and layout of views, menu and toolbars. The Framesoc Eclipse perspective can be activated by selecting it from the \textbf{Window > Open Perspective > Other... > Framesoc} menu.} for trace management and analysis.
