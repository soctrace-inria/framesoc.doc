...
\RCGrenoble 
%%
\abstract{This guide describes the Framesoc workbench, in its version 1.0.7, which is the desktop user environment provided by Framesoc infrastructure. The document targets the end-users.}
